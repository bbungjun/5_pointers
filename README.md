...
![드래그앤드롭4]()
<img src="https://github.com/user-attachments/assets/12635167-572d-4dd8-862a-60f3524cab06"
    width="700"
    autoplay="autoplay"
    loop="loop"
/>
...
|이름|역할|담당|
|:---:|:---:|:---|
|[김별](GitHub 프로필 링크)|팀장|• 실시간 협업 기능 구현<br>• 컴포넌트 시스템 설계<br>• 드래그 앤 드롭 구현|
|[@이름2](GitHub 프로필 링크)|테크 리드|• API 설계 및 구현<br>• 데이터베이스 설계<br>• WebSocket 서버 구현|
|[@이름3](GitHub 프로필 링크)|인프라 리드|• AWS 인프라 구축<br>• CI/CD 파이프라인 구축<br>• 모니터링 시스템 구축|
