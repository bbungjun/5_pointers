      ...
      <div style={{ marginTop: 'auto' }}>
        <button
          ...
          style={{
            ...
            borderRadius:
              mode === 'live'
                ? `${(parseInt(comp.props?.borderRadius) || 8) * scaleFactor}px`
                : comp.props?.borderRadius || '8px',
            padding:
              mode === 'live'
            ...
            fontSize:
              mode === 'live'
                ? `${(parseInt(comp.props?.fontSize) || 16) * scaleFactor}px`
          ...
          >
            <h2
              style={{
                ...
                fontWeight: '600',
                marginBottom:
                  mode === 'live' ? `${24 * scaleFactor}px` : '24px',
                color: '#1f2937',
                textAlign: 'center',
                fontFamily:
            ...
            <div
              style={{
                marginBottom:
                  mode === 'live' ? `${20 * scaleFactor}px` : '20px',
              }}
            >
              ...
              <div
                style={{
                  display: 'flex',
                  gap: mode === 'live' ? `${16 * scaleFactor}px` : '16px',
                }}
              >
                {['신부측', '신랑측'].map((side) => (
                  <label
                  ...
                  >
                    <input
                      ...
                      style={{
                        marginRight:
                          mode === 'live' ? `${8 * scaleFactor}px` : '8px',
                      }}
                    />
                    <span style={textStyle(comp, scaleFactor, mode)}>
                      {side}
                    </span>
                  </label>
                ))}
...
const FormInput = ({
  ...
  <div
    style={{ marginBottom: mode === 'live' ? `${20 * scaleFactor}px` : '20px' }}
  >
    <label style={labelStyle(comp, scaleFactor, mode)}>
